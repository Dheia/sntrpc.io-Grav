...
return [
    ...
    'timestamp' => 1680280012,
    'checksum' => 'e497686395c3946dfd0bb683f30c0653',
    'files' => [
        'user/sntrpc.com/config' => [
            'plugins/login' => [
                'file' => 'user/sntrpc.com/config/plugins/login.yaml',
                'modified' => 1680280002
            ],
            'security' => [
                'file' => 'user/sntrpc.com/config/security.yaml',
                'modified' => 1680280002
            ],
            'themes/quark' => [
                'file' => 'user/sntrpc.com/config/themes/quark.yaml',
                'modified' => 1680280002
            ]
        ],
        'user/config' => [
            ...
            'themes/simplicity' => [
                'file' => 'user/config/themes/simplicity.yaml',
                'modified' => 1680280001
            ],
            'versions' => [
        ...
        'user/plugins' => [
            ...
            'plugins/tools-collection' => [
                'file' => 'user/plugins/tools-collection/tools-collection.yaml',
                'modified' => 1680280002
            ],
            'plugins/form' => [
        ...
        'user/themes' => [
            ...
            'themes/simplicity' => [
                'file' => 'user/themes/simplicity/simplicity.yaml',
                'modified' => 1680280002
            ]
        ]
    ],
    'data' => [
        'themes' => [
            'quark' => [
                ...
                'custom_logo' => [
                    'user/themes/quark/images/logo/sin W77x5_YZ_400x400 homepage header w sntrpc.png' => [
                        'name' => 'sin W77x5_YZ_400x400 homepage header w sntrpc.png',
                        'full_path' => 'sin W77x5_YZ_400x400 homepage header w sntrpc.png',
                        'type' => 'image/png',
                        'size' => 274018,
                        'path' => 'user/themes/quark/images/logo/sin W77x5_YZ_400x400 homepage header w sntrpc.png'
                    ]
                ],
                'custom_logo_mobile' => [
                    'user/themes/quark/images/logo/sin W77x5_YZ_400x400 homepage header w sntrpc.png' => [
            ...
            'simplicity' => [
                ...
                'header' => [
                    ...
                    'social' => [
                        ...
                        'facebook' => 'https://facebook.com/sntrpc',
                        'twitter' => 'https://twitter.com/sntrpc',
                        'linkedin' => 'https://linkedin.com/in/sntrpc',

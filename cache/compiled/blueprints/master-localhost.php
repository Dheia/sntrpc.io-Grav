...
return [
    ...
    'timestamp' => 1680283811,
    'checksum' => 'cee0df91533d487f055758b8157cc542',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/tools-collection' => [
                'file' => 'user/plugins/tools-collection/blueprints.yaml',
                'modified' => 1680280002
            ]
        ],
        'user/themes' => [
            'themes/simplicity' => [
                'file' => 'user/themes/simplicity/blueprints.yaml',
                'modified' => 1680280002
            ],
            'themes/quark' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.tools-collection.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.tools-collection.enabled',
                'validation' => 'strict'
            ],
            'plugins.tools-collection.markdown' => [
                'type' => '_parent',
                'name' => 'plugins.tools-collection.markdown',
                'form_field' => false
            ],
            'plugins.tools-collection.markdown.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.tools-collection.markdown.enabled',
                'validation' => 'strict'
            ],
            'plugins.tools-collection.filter' => [
                'type' => '_parent',
                'name' => 'plugins.tools-collection.filter',
                'form_field' => false
            ],
            'plugins.tools-collection.filter.twigextension' => [
                'type' => '_parent',
                'name' => 'plugins.tools-collection.filter.twigextension',
                'form_field' => false
            ],
            'plugins.tools-collection.filter.twigextension.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.tools-collection.filter.twigextension.enabled',
                'validation' => 'strict'
            ],
            'plugins.tools-collection.filter.twigextension.modules' => [
                'type' => 'selectize',
                'size' => 'large',
                ...
                'name' => 'plugins.tools-collection.filter.twigextension.modules',
                'validation' => 'strict'
            ],
            'plugins.tools-collection.pageblueprint' => [
                'type' => '_parent',
                'name' => 'plugins.tools-collection.pageblueprint',
                'form_field' => false
            ],
            'plugins.tools-collection.pageblueprint.options' => [
                'type' => '_parent',
                'name' => 'plugins.tools-collection.pageblueprint.options',
                'form_field' => false
            ],
            'plugins.tools-collection.pageblueprint.options.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.tools-collection.pageblueprint.options.enabled',
                'validation' => 'strict'
            ],
            'plugins.tools-collection.pageblueprint.advanced' => [
                'type' => '_parent',
                'name' => 'plugins.tools-collection.pageblueprint.advanced',
                'form_field' => false
            ],
            'plugins.tools-collection.pageblueprint.advanced.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.tools-collection.pageblueprint.advanced.enabled',
                'validation' => 'strict'
            ],
            'plugins.tools-collection.imageresize' => [
                'type' => '_parent',
                'name' => 'plugins.tools-collection.imageresize',
                'form_field' => false
            ],
            'plugins.tools-collection.imageresize.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.tools-collection.imageresize.enabled',
                'validation' => 'strict'
            ],
            'plugins.tools-collection.imageresize.adapter' => [
                'type' => 'select',
                ...
                'name' => 'plugins.tools-collection.imageresize.adapter',
                'validation' => 'strict'
            ],
            'plugins.tools-collection.imageresize.remove_original' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.tools-collection.imageresize.remove_original',
                'validation' => 'strict'
            ],
            'plugins.tools-collection.imageresize.sizes' => [
                'array' => true,
                'type' => 'list',
                'label' => 'PLUGIN_TOOLS_COLLECTION.RESIZE.IMAGE_SIZES',
                'collapsed' => true,
                'name' => 'plugins.tools-collection.imageresize.sizes',
                'validation' => 'strict'
            ],
            'plugins.tools-collection.imageresize.sizes.*' => [
                'type' => '_parent',
            ...
            'plugins.tools-collection.imageresize.sizes.*.width' => [
                'type' => 'number',
                'label' => 'PLUGIN_TOOLS_COLLECTION.RESIZE.WIDTH',
                'min' => 1,
                'name' => 'plugins.tools-collection.imageresize.sizes.*.width',
                'validation' => 'strict'
            ],
            'plugins.tools-collection.imageresize.sizes.*.quality' => [
                'type' => 'number',
                'label' => 'PLUGIN_TOOLS_COLLECTION.RESIZE.QUALITY',
                'min' => 0,
                'max' => 100,
                'default' => 82,
                'name' => 'plugins.tools-collection.imageresize.sizes.*.quality',
                'validation' => 'strict'
            ],
            'plugins.tools-collection.imageresize.mode' => [
                'type' => 'select',
                ...
                'name' => 'plugins.tools-collection.imageresize.mode',
                'validation' => 'strict'
            ],
            'plugins.tools-collection.imageresize.auswahl' => [
                'type' => 'selectize',
                'label' => 'PLUGIN_TOOLS_COLLECTION.RESIZE.USE_IN',
                'validate' => [
                    'type' => 'commalist'
                ],
                'name' => 'plugins.tools-collection.imageresize.auswahl',
                'validation' => 'strict'
            ],
            'plugins.tools-collection.infopanel' => [
                'type' => '_parent',
                'name' => 'plugins.tools-collection.infopanel',
                'form_field' => false
            ],
            'plugins.tools-collection.infopanel.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.tools-collection.infopanel.enabled',
                'validation' => 'strict'
            ],
            'plugins.tools-collection.infopanel.navtitel' => [
                'type' => 'text',
                'label' => 'PLUGIN_TOOLS_COLLECTION.INFOPANEL.NAV_TITLE',
                'name' => 'plugins.tools-collection.infopanel.navtitel',
                'validation' => 'strict'
            ],
            'plugins.tools-collection.infopanel.sitetitel' => [
                'type' => 'text',
                'label' => 'PLUGIN_TOOLS_COLLECTION.INFOPANEL.SITE_TITLE',
                'name' => 'plugins.tools-collection.infopanel.sitetitel',
                'validation' => 'strict'
            ],
            'plugins.tools-collection.infopanel.titel' => [
                'type' => 'text',
                'label' => 'PLUGIN_TOOLS_COLLECTION.INFOPANEL.HEADING',
                'name' => 'plugins.tools-collection.infopanel.titel',
                'validation' => 'strict'
            ],
            'plugins.tools-collection.infopanel.text' => [
                'type' => 'textarea',
                'label' => 'PLUGIN_TOOLS_COLLECTION.INFOPANEL.TEXT',
                'name' => 'plugins.tools-collection.infopanel.text',
                'validation' => 'strict'
            ],
            'themes.simplicity' => [
                'type' => '_root',
            ...
            'themes.simplicity.header' => [
                'type' => '_parent',
                'name' => 'themes.simplicity.header',
                'form_field' => false
            ],
            'themes.simplicity.header.name' => [
                'type' => 'text',
                'label' => 'THEME_SIMPLICITY.ADMIN.FIELDS.NAME.LABEL',
                'validate' => [
                    'required' => true
                ],
                'name' => 'themes.simplicity.header.name',
                'validation' => 'loose'
            ],
            'themes.simplicity.header.subtitle' => [
                'type' => 'text',
                'label' => 'THEME_SIMPLICITY.ADMIN.FIELDS.SUBTITLE.LABEL',
                'validate' => [
                    'required' => true
                ],
                'name' => 'themes.simplicity.header.subtitle',
                'validation' => 'loose'
            ],
            'themes.simplicity.header.image' => [
                'array' => true,
                'media_field' => true,
                'validate' => [
                    'type' => 'ignore'
                ...
                'name' => 'themes.simplicity.header.image',
                'validation' => 'loose'
            ],
            'themes.simplicity.header.social' => [
                'type' => '_parent',
                'name' => 'themes.simplicity.header.social',
                'form_field' => false
            ],
            'themes.simplicity.header.social.facebook' => [
                'type' => 'text',
                'label' => 'Facebook',
                'toggleable' => true,
                'name' => 'themes.simplicity.header.social.facebook',
                'validation' => 'loose'
            ],
            'themes.simplicity.header.social.twitter' => [
                'type' => 'text',
                'label' => 'Twitter',
                'toggleable' => true,
                'name' => 'themes.simplicity.header.social.twitter',
                'validation' => 'loose'
            ],
            'themes.simplicity.header.social.linkedin' => [
                'type' => 'text',
                'label' => 'Linkedin',
                'toggleable' => true,
                'name' => 'themes.simplicity.header.social.linkedin',
                'validation' => 'loose'
            ],
            'themes.simplicity.header.social.github' => [
                'type' => 'text',
                'label' => 'Github',
                'toggleable' => true,
                'name' => 'themes.simplicity.header.social.github',
                'validation' => 'loose'
            ],
            'themes.simplicity.header.social.google' => [
                'type' => 'text',
                'label' => 'Google+',
                'toggleable' => true,
                'name' => 'themes.simplicity.header.social.google',
                'validation' => 'loose'
            ],
            'themes.quark' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'tools-collection' => [
                    'enabled' => 'plugins.tools-collection.enabled',
                    'markdown' => [
                        'enabled' => 'plugins.tools-collection.markdown.enabled'
                    ],
                    'filter' => [
                        'twigextension' => [
                            'enabled' => 'plugins.tools-collection.filter.twigextension.enabled',
                            'modules' => 'plugins.tools-collection.filter.twigextension.modules'
                        ]
                    ],
                    'pageblueprint' => [
                        'options' => [
                            'enabled' => 'plugins.tools-collection.pageblueprint.options.enabled'
                        ],
                        'advanced' => [
                            'enabled' => 'plugins.tools-collection.pageblueprint.advanced.enabled'
                        ]
                    ],
                    'imageresize' => [
                        'enabled' => 'plugins.tools-collection.imageresize.enabled',
                        'adapter' => 'plugins.tools-collection.imageresize.adapter',
                        'remove_original' => 'plugins.tools-collection.imageresize.remove_original',
                        'sizes' => [
                            '*' => [
                                'width' => 'plugins.tools-collection.imageresize.sizes.*.width',
                                'quality' => 'plugins.tools-collection.imageresize.sizes.*.quality'
                            ]
                        ],
                        'mode' => 'plugins.tools-collection.imageresize.mode',
                        'auswahl' => 'plugins.tools-collection.imageresize.auswahl'
                    ],
                    'infopanel' => [
                        'enabled' => 'plugins.tools-collection.infopanel.enabled',
                        'navtitel' => 'plugins.tools-collection.infopanel.navtitel',
                        'sitetitel' => 'plugins.tools-collection.infopanel.sitetitel',
                        'titel' => 'plugins.tools-collection.infopanel.titel',
                        'text' => 'plugins.tools-collection.infopanel.text'
                    ]
                ]
            ],
            'themes' => [
                'simplicity' => [
                    'header' => [
                        'name' => 'themes.simplicity.header.name',
                        'subtitle' => 'themes.simplicity.header.subtitle',
                        'image' => 'themes.simplicity.header.image',
                        'social' => [
                            'facebook' => 'themes.simplicity.header.social.facebook',
                            'twitter' => 'themes.simplicity.header.social.twitter',
                            'linkedin' => 'themes.simplicity.header.social.linkedin',
                            'github' => 'themes.simplicity.header.social.github',
                            'google' => 'themes.simplicity.header.social.google'
                        ]
                    ]
                ],
                'quark' => [
